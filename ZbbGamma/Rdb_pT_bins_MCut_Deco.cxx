...
void CreateDirectories(const char* wp_label) {
    ...
    TString baseDir = Form("../Plots/DB_Deco/PlotsRdbpTbin/%s", wp_label);
...
void ProcessWorkingPoint(const char* wp_label) {
    ...
    std::string dataPath = basePath + "NtupleSlim/DB_Deco_" + wp_label + "wp_slim/data_deco_" + wp_label + "wp_slim.root";
    std::string zbbPath = basePath + "NtupleSlim/DB_Deco_" + wp_label + "wp_slim/Zbby_deco_" + wp_label + "wp_slim.root";
    std::string mjPath = basePath + "NtupleSlim/DB_Deco_" + wp_label + "wp_slim/gamma_jets_deco_" + wp_label + "wp_slim.root";
    ...
    for (int m = 0; m < nMassCuts; m++) {
        ...
        TString summaryFileName = Form("../Plots/DB_Deco/PlotsRdbpTbin/%s/%s/R_DB_pT_binned_fit_summary.txt", wp_label, fileSystemMassCutLabels[m]);
        ...
        for (int bin = 0; bin < nPtBins; bin++) {
            ...
            mc_canvas->SaveAs(Form("../Plots/DB_Deco/PlotsRdbpTbin/%s/%s/Fit_R_DB_mc_ptbin%d.pdf", wp_label, fileSystemMassCutLabels[m], bin));
            
            // Save fit parameters
            SaveFitParameters(Form("../Plots/DB_Deco/PlotsRdbpTbin/%s/%s/mc_fit_parameters_ptbin%d.txt", wp_label, fileSystemMassCutLabels[m], bin),
            ...
            data_canvas->SaveAs(Form("../Plots/DB_Deco/PlotsRdbpTbin/%s/%s/Fit_R_DB_data_ptbin%d.pdf", wp_label, fileSystemMassCutLabels[m], bin));
            
            // Save fit parameters
            SaveFitParameters(Form("../Plots/DB_Deco/PlotsRdbpTbin/%s/%s/data_fit_parameters_ptbin%d.txt", wp_label, fileSystemMassCutLabels[m], bin),
            ...
            bkg_canvas->SaveAs(Form("../Plots/DB_Deco/PlotsRdbpTbin/%s/%s/Fit_R_DB_bkg_ptbin%d.pdf", wp_label, fileSystemMassCutLabels[m], bin));
            
            // Save fit parameters
            SaveFitParameters(Form("../Plots/DB_Deco/PlotsRdbpTbin/%s/%s/bkg_fit_parameters_ptbin%d.txt", wp_label, fileSystemMassCutLabels[m], bin),
            ...
            combined_canvas->SaveAs(Form("../Plots/DB_Deco/PlotsRdbpTbin/%s/%s/Fit_R_DB_combined_MC_ptbin%d.pdf", wp_label, fileSystemMassCutLabels[m], bin));
            
            // Save fit parameters
            SaveFitParameters(Form("../Plots/DB_Deco/PlotsRdbpTbin/%s/%s/combined_MC_fit_parameters_ptbin%d.txt", wp_label, fileSystemMassCutLabels[m], bin),
            ...
            stack_canvas->SaveAs(Form("../Plots/DB_Deco/PlotsRdbpTbin/%s/%s/R_DB_stack_comparison_ptbin%d.pdf", wp_label, fileSystemMassCutLabels[m], bin));
            ...
            combinedstack_canvas->SaveAs(Form("../Plots/DB_Deco/PlotsRdbpTbin/%s/%s/R_DB_stack_ratio_ptbin%d.pdf", wp_label, fileSystemMassCutLabels[m], bin));
        ...
        mean_canvas->SaveAs(Form("../Plots/DB_Deco/PlotsRdbpTbin/%s/%s/R_DB_mean_vs_pT.pdf", wp_label, fileSystemMassCutLabels[m]));
        ...
        sigma_canvas->SaveAs(Form("../Plots/DB_Deco/PlotsRdbpTbin/%s/%s/R_DB_sigma_vs_pT.pdf", wp_label, fileSystemMassCutLabels[m]));
        ...
        ratio_canvas->SaveAs(Form("../Plots/DB_Deco/PlotsRdbpTbin/%s/%s/R_DB_mean_ratio_vs_pT.pdf", wp_label, fileSystemMassCutLabels[m]));
        ...
        data_combined_canvas->SaveAs(Form("../Plots/DB_Deco/PlotsRdbpTbin/%s/%s/R_DB_data_combined_ratio_vs_pT.pdf", wp_label, fileSystemMassCutLabels[m]));
    ...
    for (int bin = 0; bin < nPtBins; bin++) {
        ...
        mass_mean_canvas->SaveAs(Form("../Plots/DB_Deco/PlotsRdbpTbin/%s/R_DB_mean_vs_masscut_ptbin%d.pdf", wp_label, bin));
        ...
        mass_sigma_canvas->SaveAs(Form("../Plots/DB_Deco/PlotsRdbpTbin/%s/R_DB_sigma_vs_masscut_ptbin%d.pdf", wp_label, bin));
        ...
        mass_ratio_canvas->SaveAs(Form("../Plots/DB_Deco/PlotsRdbpTbin/%s/R_DB_ratio_vs_masscut_ptbin%d.pdf", wp_label, bin));
    ...
    all_ratio_canvas->SaveAs(Form("../Plots/DB_Deco/PlotsRdbpTbin/%s/R_DB_all_ratio_summary.pdf", wp_label));
    ...
    bkg_ratio_canvas->SaveAs(Form("../Plots/DB_Deco/PlotsRdbpTbin/%s/R_DB_bkg_ratio_summary.pdf", wp_label));
