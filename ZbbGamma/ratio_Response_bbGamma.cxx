...
const int nPtBins = 2;
const double ptBins[nPtBins + 1] = {200, 300, 450}; // 200-300, 300-450
const char* ptBinLabels[nPtBins] = {"200 < p_{T} < 300 GeV", "300 < p_{T} < 450 GeV"};
...
void CreateRatioDirectories(const std::string& fileWP) {
    gSystem->Exec(Form("mkdir -p ../Plots/DB_Ratio/%s/PlotsRdbpTbin/Summary", fileWP.c_str()));
    //gSystem->Exec(Form("mkdir -p ../Plots/MJB/%s/PlotsRdbpTbin/Summary", fileWP.c_str())); // Commented out as per original code
    //gSystem->Exec(Form("mkdir -p ../Plots/DB_Deco/%s/PlotsRdbpTbin/Summary", fileWP.c_str())); // Commented out as per original code
}
...
void CreateSummaryPlots(
    ...
    legend_process_mean->AddEntry((TObject*)0, "Z (#rightarrow bb) + #gamma", "");
    ...
    summary_mean_canvas->SaveAs(Form("../Plots/DB_Ratio/%s/PlotsRdbpTbin/Summary/Summary_Mean_Ratios_vs_pT_%s.pdf", fileWP.c_str(), fileWP.c_str()));
    ...
    legend_process_sigma->AddEntry((TObject*)0, "Z (#rightarrow bb) + #gamma", "");
    ...
    summary_sigma_canvas->SaveAs(Form("../Plots/DB_Ratio/%s/PlotsRdbpTbin/Summary/Summary_Resolution_Ratios_vs_pT_%s.pdf", fileWP.c_str(), fileWP.c_str()));
...
void process_single_wp_ratio(const std::string& wp_str) { // Renamed from ratio_Response
    ...
    std::string dataPath_before = Form("../../NtupleSlim/DB_%swp_slim/data_%swp_slim.root", fileWP.c_str(), fileWP.c_str());
    std::string zbbPath_before = Form("../../NtupleSlim/DB_%swp_slim/Zbby_%swp_slim.root", fileWP.c_str(), fileWP.c_str());
    std::string mjPath_before = Form("../../NtupleSlim/DB_%swp_slim/gamma_jets_%swp_slim.root", fileWP.c_str(), fileWP.c_str());
    ...
    std::string dataPath_after = Form("../../NtupleSlim/DB_Deco_%swp_slim/data_deco_%swp_slim.root", fileWP.c_str(), fileWP.c_str());
    std::string zbbPath_after = Form("../../NtupleSlim/DB_Deco_%swp_slim/Zbby_deco_%swp_slim.root", fileWP.c_str(), fileWP.c_str());
    std::string mjPath_after = Form("../../NtupleSlim/DB_Deco_%swp_slim/gamma_jets_deco_%swp_slim.root", fileWP.c_str(), fileWP.c_str());
    ...
    // --- Calculate the ratio of R_DB_mean_values (Post_bJR10V00/Pre_bJR10V00) for Data, MC, Bkg, and Combined MC ---
    ...
    // --- Calculate the ratio of R_DB_sigma_values (Post_bJR10V00/Pre_bJR10V00) for Data, MC, Bkg, and Combined MC ---
    ...
    DrawAtlasLabel();
    ratio_data_canvas->SaveAs(Form("../Plots/DB_Ratio/%s/PlotsRdbpTbin/Summary/Data_R_DB_mean_ratio_Post_Pre_bJR10v00.pdf", fileWP.c_str()));
    ...
    DrawAtlasLabel();
    ratio_mc_canvas->SaveAs(Form("../Plots/DB_Ratio/%s/PlotsRdbpTbin/Summary/MC_R_DB_mean_ratio_Post_Pre_bJR10v00.pdf", fileWP.c_str()));
    ...
    DrawAtlasLabel();
    ratio_bkg_canvas->SaveAs(Form("../Plots/DB_Ratio/%s/PlotsRdbpTbin/Summary/Bkg_R_DB_mean_ratio_Post_Pre_bJR10v00.pdf", fileWP.c_str()));
    ...
    DrawAtlasLabel();
    ratio_combined_canvas->SaveAs(Form("../Plots/DB_Ratio/%s/PlotsRdbpTbin/Summary/Combined_MC_R_DB_mean_ratio_Post_Pre_bJR10v00.pdf", fileWP.c_str()));
    ...
    DrawAtlasLabel();
    final_ratio_mean_canvas->SaveAs(Form("../Plots/DB_Ratio/%s/PlotsRdbpTbin/Summary/Data_Over_Combined_MC_Ratio_Post_Pre_bJR10v00_Means.pdf", fileWP.c_str()));
    ...
    DrawAtlasLabel();
    ratio_data_sigma_canvas->SaveAs(Form("../Plots/DB_Ratio/%s/PlotsRdbpTbin/Summary/Data_R_DB_sigma_ratio_Post_Pre_bJR10v00.pdf", fileWP.c_str()));
    ...
    DrawAtlasLabel();
    ratio_mc_sigma_canvas->SaveAs(Form("../Plots/DB_Ratio/%s/PlotsRdbpTbin/Summary/MC_R_DB_sigma_ratio_Post_Pre_bJR10v00.pdf", fileWP.c_str()));
    ...
    DrawAtlasLabel();
    ratio_bkg_sigma_canvas->SaveAs(Form("../Plots/DB_Ratio/%s/PlotsRdbpTbin/Summary/Bkg_R_DB_sigma_ratio_Post_Pre_bJR10v00.pdf", fileWP.c_str()));
    ...
    DrawAtlasLabel();
    ratio_combined_sigma_canvas->SaveAs(Form("../Plots/DB_Ratio/%s/PlotsRdbpTbin/Summary/Combined_MC_R_DB_sigma_ratio_Post_Pre_bJR10v00.pdf", fileWP.c_str()));
    ...
    DrawAtlasLabel();
    final_ratio_sigma_canvas->SaveAs(Form("../Plots/DB_Ratio/%s/PlotsRdbpTbin/Summary/Data_Over_Combined_MC_Ratio_Post_Pre_bJR10v00_Sigmas.pdf", fileWP.c_str()));
    std::cout << "Data/(Combined MC) resolution ratio (Post_bJR10V00/Pre_bJR10V00) plot generated successfully." << std::endl;

    // Generate summary table
    std::string summaryFilePath = Form("../Plots/DB_Ratio/%s/PlotsRdbpTbin/Summary/Summary_Ratios_%s.txt", fileWP.c_str(), fileWP.c_str());
...
void ratio_Response_bbGamma() { // Main entry point for ROOT
