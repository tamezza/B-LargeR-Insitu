...
void CompareEfficiencies() {
    ...
    // Define EOS path
    //std::string eosPath = "root://eosuser.cern.ch//eos/user/t/" + username + "/Documents/EasyBjets/Zbby/";
    std::string eosPath = "../../";
    ...
    for (size_t i = 0; i < workingPoints.size(); ++i) {
        ...
        std::string dataPath = eosPath + "NtupleSlim/DB_" + fileWP + "wp_slim/data_" + fileWP + "wp_slim.root";
        std::string signalPath = eosPath + "NtupleSlim/DB_" + fileWP + "wp_slim/Zbby_" + fileWP + "wp_slim.root";
        std::string bkgPath = eosPath + "NtupleSlim/DB_" + fileWP + "wp_slim/gamma_jets_" + fileWP + "wp_slim.root";
    ...
    for (int wpIndex = 0; wpIndex < workingPoints.size(); ++wpIndex) {
        ...
        canvasComp->SaveAs(("../Plots/DB/CutFlow/EfficiencyComparison_DataSignalBkg_WP" + workingPoints[wpIndex] + ".pdf").c_str());
        //canvasComp->SaveAs(("../Plots/DB/CutFlow/EfficiencyComparison_DataSignalBkg_WP" + workingPoints[wpIndex] + ".png").c_str());
    ...
    canvasAll->SaveAs("../Plots/DB/CutFlow/EfficiencyComparison_AllWPs_Grid.pdf");
    //canvasAll->SaveAs("../Plots/DB/CutFlow/EfficiencyComparison_AllWPs_Grid.png");
...
void CompareEfficienciesData() {
    ...
    for (size_t i = 0; i < workingPoints.size(); ++i) {
        ...
        // Process DATA file
        std::string filePath = eosPath + "NtupleSlim/DB_" + fileWP + "wp_slim/data_" + fileWP + "wp_slim.root";
    ...
    canvasEff->SaveAs("../Plots/DB/CutFlow/DataEfficiencyComparison_log.pdf");
    //canvasEff->SaveAs("../Plots/DB/CutFlow/DataEfficiencyComparison_log.png");
    ...
    canvasSignal->SaveAs("../Plots/DB/CutFlow/SignalEfficiencyComparison_log.pdf");
    //canvasSignal->SaveAs("../Plots/DB/CutFlow/SignalEfficiencyComparison_log.png");
    ...
    canvasBkg->SaveAs("../Plots/DB/CutFlow/BackgroundEfficiencyComparison_log.pdf");
    //canvasBkg->SaveAs("../Plots/DB/CutFlow/BackgroundEfficiencyComparison_log.png");
    ...
    canvasEffLinear->SaveAs("../Plots/DB/CutFlow/DataEfficiencyComparison_Linear.pdf");
    //canvasEffLinear->SaveAs("../Plots/DB/CutFlow/DataEfficiencyComparison_Linear.png");
...
void CompareSignalToBackground() {
    ...
    // Define EOS path
    //std::string basePath = "root://eosuser.cern.ch//eos/user/t/" + username + "/Documents/EasyBjets/Zbby/";
    std::string basePath = "../../";
    ...
    for (const auto& wp : workingPoints) {
        ...
        std::string dataPath = basePath + "NtupleSlim/DB_" + fileWP + "wp_slim/data_" + fileWP + "wp_slim.root";
        std::string zbbPath = basePath + "NtupleSlim/DB_" + fileWP + "wp_slim/Zbby_" + fileWP + "wp_slim.root";
        std::string mjPath = basePath + "NtupleSlim/DB_" + fileWP + "wp_slim/gamma_jets_" + fileWP + "wp_slim.root";
    ...
    // Save the plot
    canvasSB->SaveAs("../Plots/DB/CutFlow/SignalToBackgroundRatio.pdf");
    //canvasSB->SaveAs("../Plots/DB/CutFlow/SignalToBackgroundRatio.png");
...
void CompareDataToMC() {
    ...
    for (int i = 0; i < workingPoints.size(); ++i) {
        ...
        std::string dataPath = eosPath + "NtupleSlim/DB_" + fileWP + "wp_slim/data_" + fileWP + "wp_slim.root";
        std::string zbbPath = eosPath + "NtupleSlim/DB_" + fileWP + "wp_slim/Zbby_" + fileWP + "wp_slim.root";
        std::string mjPath = eosPath + "NtupleSlim/DB_" + fileWP + "wp_slim/gamma_jets_" + fileWP + "wp_slim.root";
    ...
    // Save the plot
    canvasDMC->SaveAs("../Plots/DB/CutFlow/DataMCRatio.pdf");
    //canvasDMC->SaveAs("../Plots/DB/CutFlow/DataMCRatio.png");
...
void IndividualStackedCutflows() {
   ...
   std::vector<std::string> cutNames = {
    ...
    for (const auto& wp : workingPoints) {
        ...
        canvas->SaveAs(("../Plots/DB/CutFlow/StackedCutflow_WP" + labelWP + ".pdf").c_str());
        //canvas->SaveAs(("../Plots/DB/CutFlow/StackedCutflow_WP" + labelWP + ".png").c_str());
        ...
        cutflowFile.open(("../Plots/DB/CutFlow/CutflowTable_WP" + labelWP + ".txt").c_str());
        ...
        summary << "  - Final gamma_jets events: " << finalMjEvents << "\n";
        ...
        // Close the file
        cutflowFile.close();
        std::cout << "Cutflow table saved to: " << ("../Plots/DB/CutFlow/CutflowTable_WP" + labelWP + ".txt") << std::endl;
        ...
        if (dataInitial > 0 && zbbInitial > 0 && mjInitial > 0) {
            ...
            // Save the plot
            canvasEff->SaveAs(("../Plots/DB/CutFlow/Efficiency_WP" + labelWP + ".pdf").c_str());
            //canvasEff->SaveAs(("../Plots/DB/CutFlow/Efficiency_WP" + labelWP + ".png").c_str());
...
void CutFlow() {
    ...
    std::string outputPath = "../Plots/DB/CutFlow/";
