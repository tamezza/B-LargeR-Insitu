...
void Process2DPlotsOnly(const char* wp_label) {
    ...
    data_means_canvas->SaveAs(Form("../Plots/MJB/2DplotsRdbpTbin/%s/Summary/Data_R_DB_Deco_mean_values.pdf", wp_label));
    ...
    mc_means_canvas->SaveAs(Form("../Plots/MJB/2DplotsRdbpTbin/%s/Summary/MC_R_DB_Deco_mean_values.pdf", wp_label));
    ...
    bkg_means_canvas->SaveAs(Form("../Plots/MJB/2DplotsRdbpTbin/%s/Summary/Bkg_R_DB_Deco_mean_values.pdf", wp_label));
    ...
    combined_means_canvas->SaveAs(Form("../Plots/MJB/2DplotsRdbpTbin/%s/Summary/Combined_MC_R_DB_Deco_mean_values.pdf", wp_label));
