...
*/
    ...
    WorkingPoint(const std::string& wp) : name(wp) {
        ...
        inputFiles = {
            "../../Data/DB_Deco/data_0p" + wp + "wp_slim.root",          
            "../../Data/DB_Deco/Multijets_0p" + wp + "wp_slim.root",      
            "../../Data/DB_Deco/ZbbJets_0p" + wp + "wp_slim.root"         
            
        };
        outputDir = "../Plots/DB_Deco/" + wp + "/MassRdb/";
    }
};
*/
...
struct WorkingPoint {
    ...
    WorkingPoint(const std::string& wp) : name(wp) {
        ...
        /*inputFiles = {
            eosPath + "NtupleSlim/DB_Deco_0p" + wp + "wp_slim/data_0p" + wp + "wp_slim.root",          
            eosPath + "NtupleSlim/DB_Deco_0p" + wp + "wp_slim/Multijets_0p" + wp + "wp_slim.root",      
            eosPath + "NtupleSlim/DB_Deco_0p" + wp + "wp_slim/ZbbJets_0p" + wp + "wp_slim.root"         
        };
        ...
        inputFiles = {
            eosPath + "NtupleSlim/DB_Deco_" + fileWP + "wp_slim/data_deco_" + fileWP + "wp_slim.root",          
            eosPath + "NtupleSlim/DB_Deco_" + fileWP + "wp_slim/gamma_jets_deco_" + fileWP + "wp_slim.root",      
            eosPath + "NtupleSlim/DB_Deco_" + fileWP + "wp_slim/Zbby_deco_" + fileWP + "wp_slim.root"         
        };
        //outputDir = "../Plots/DB_Deco/" + fileWP + "/MassResponse/";
        outputDir = "../Plots/DB_Deco/MassResponse/" + fileWP + "/";
    }
...
private:
    std::vector<TH1F*> ljet_bJR10v00_mass;
    std::vector<TH1F*> ljet_bJR10v00_mass_50_350;
    std::vector<TH1F*> ljet_bJR10v00_mass_50_150;
    std::vector<TH1F*> ljet_bJR10v00_mass_50_150_2;
...
public:
    ...
    ~HistogramManager() {
        ...
        for (auto hist : ljet_bJR10v00_mass) delete hist;
        for (auto hist : ljet_bJR10v00_mass_50_350) delete hist;
        for (auto hist : ljet_bJR10v00_mass_50_150) delete hist;
        for (auto hist : ljet_bJR10v00_mass_50_150_2) delete hist;
    ...
    void InitializeHistograms() {
        InitializeHistogramGroup(ljet_bJR10v00_mass, "ljet_bJR10v00_mass", "Large-R Jet Mass;M^{J} [GeV];Events", 50, 50, 200);
        InitializeHistogramGroup(ljet_bJR10v00_mass_50_350, "ljet_bJR10v00_mass_50_350", "Large-R Jet Mass;M^{J} [GeV];Events", 50, 50, 350);
        InitializeHistogramGroup(ljet_bJR10v00_mass_50_150, "ljet_bJR10v00_mass_50_150", "Large-R Jet Mass;M^{J} [GeV];Events", 20, 50, 150);
        InitializeHistogramGroup(ljet_bJR10v00_mass_50_150_2, "ljet_bJR10v00_mass_50_150_2", "Large-R Jet Mass;M^{J} [GeV];Events", 50, 50, 150);
        ...
        SetHistogramColors(ljet_bJR10v00_mass);
        SetHistogramColors(ljet_bJR10v00_mass_50_350);
        SetHistogramColors(ljet_bJR10v00_mass_50_150);
        SetHistogramColors(ljet_bJR10v00_mass_50_150_2);
        ...
        for (Long64_t i = 0; i < nentries; ++i) {
            ...
            if (!isData && ljet_flavour_label && ljet_truth_label) {
                ...
                if (jet_bin < h_R_DB_bins.size()) {
                    ...
                    h_mass_bins[jet_bin]->Fill((ljet_bJR10v00_mass->at(0))/1000.0, weight);
                }
            }
        }
    ...
    void ProcessFiles(const std::vector<std::string>& files) {
        ...
        for (size_t i = 0; i < trees.size(); ++i) {
            ...
            std::vector<TH1F*> histograms = {
                ljet_bJR10v00_mass[i], ljet_bJR10v00_mass_50_350[i], ljet_bJR10v00_mass_50_150[i], 
                ljet_bJR10v00_mass_50_150_2[i], h_Asym[i], h_Asym_2[i], 
    ...
    void CalculateAndApplyScaleFactor() {
        ...
        int binLow1 = ljet_bJR10v00_mass_50_150[1]->FindBin(50);
        int binHigh1 = ljet_bJR10v00_mass_50_150[1]->FindBin(65);
        int binLow2 = ljet_bJR10v00_mass_50_150[1]->FindBin(110);
        int binHigh2 = ljet_bJR10v00_mass_50_150[1]->FindBin(150);
        ...
        for (int bin = binLow1; bin <= binHigh1; ++bin) {
            double bin_center = ljet_bJR10v00_mass_50_150[1]->GetBinCenter(bin);
            double data_content = ljet_bJR10v00_mass_50_150[0]->GetBinContent(bin);
            double mc_content = ljet_bJR10v00_mass_50_150[1]->GetBinContent(bin);
            ...
            if (mc_content > 0) {
                ...
                double data_error = ljet_bJR10v00_mass_50_150[0]->GetBinError(bin);
                double mc_error = ljet_bJR10v00_mass_50_150[1]->GetBinError(bin);
        ...
        std::vector<TH1F*> multijetHistograms = {
            ljet_bJR10v00_mass[1], ljet_bJR10v00_mass_50_350[1], ljet_bJR10v00_mass_50_150[1],
            ljet_bJR10v00_mass_50_150_2[1]
        };
    ...
    void SaveHistograms(bool createRatioPlots = true) {
        ...
        std::vector<std::vector<TH1F*>> histogramGroups = {
            ljet_bJR10v00_mass, ljet_bJR10v00_mass_50_350, ljet_bJR10v00_mass_50_150, ljet_bJR10v00_mass_50_150_2,
