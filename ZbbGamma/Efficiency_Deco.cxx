...
void CompareEfficiencies() {
    ...
    canvasEff->SaveAs("../Plots/DB_Deco/Efficiency/DataEfficiencyComparison_log.pdf");
    //canvasEff->SaveAs("../Plots/DB_Deco/Efficiency/DataEfficiencyComparison_log.png");
    ...
    canvasSignal->SaveAs("../Plots/DB_Deco/Efficiency/SignalEfficiencyComparison_log.pdf");
    //canvasSignal->SaveAs("../Plots/DB_Deco/Efficiency/SignalEfficiencyComparison_log.png");
    ...
    canvasBkg->SaveAs("../Plots/DB_Deco/Efficiency/BackgroundEfficiencyComparison_log.pdf");
    //canvasBkg->SaveAs("../Plots/DB_Deco/Efficiency/BackgroundEfficiencyComparison_log.png");
    ...
    canvasEffLinear->SaveAs("../Plots/DB_Deco/Efficiency/DataEfficiencyComparison_Linear.pdf");
    //canvasEffLinear->SaveAs("../Plots/DB_Deco/Efficiency/DataEfficiencyComparison_Linear.png");
...
void Efficiency_Deco() {
    ...
    std::string outputPath = "../Plots/DB_Deco/Efficiency/";
