...
void MassIsolationExtractSig_MJB(const std::string& wp) {
    ...
    std::string outputDirPath = "../Plots/DB/MassIsolation/" + fileWP + "/";
    ...
    TH1F *h_mc_ljet_m = new TH1F("h_mc_ljet_m", "Large-R Jet Mass", 20, 50, 150);
    TH1F *h_data_ljet_m = new TH1F("h_data_ljet_m", "Large-R Jet Mass", 20, 50, 150);
    TH1F *h_multijets_ljet_m = new TH1F("h_multijets_ljet_m", "Large-R Jet Mass", 20, 50, 150);
