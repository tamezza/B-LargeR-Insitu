...
void CompareEfficiencies() {
    ...
    canvasEff->SaveAs("../Plots/DB/Efficiency/DataEfficiencyComparison_log.pdf");
    //canvasEff->SaveAs("../Plots/DB/Efficiency/DataEfficiencyComparison_log.png");
    ...
    canvasSignal->SaveAs("../Plots/DB/Efficiency/SignalEfficiencyComparison_log.pdf");
    //canvasSignal->SaveAs("../Plots/DB/Efficiency/SignalEfficiencyComparison_log.png");
    ...
    canvasBkg->SaveAs("../Plots/DB/Efficiency/BackgroundEfficiencyComparison_log.pdf");
    //canvasBkg->SaveAs("../Plots/DB/Efficiency/BackgroundEfficiencyComparison_log.png");
    ...
    canvasEffLinear->SaveAs("../Plots/DB/Efficiency/DataEfficiencyComparison_Linear.pdf");
    //canvasEffLinear->SaveAs("../Plots/DB/Efficiency/DataEfficiencyComparison_Linear.png");
...
void Efficiency() {
    ...
    std::string outputPath = "../Plots/DB/Efficiency/";
