...
void CompareEfficiencies() {
    ...
    for (size_t i = 0; i < workingPoints.size(); ++i) {
        ...
        std::string dataPath = eosPath + "NtupleSlim/MJB_" + fileWP + "wp_slim/data_" + fileWP + "wp_slim.root";
        std::string signalPath = eosPath + "NtupleSlim/MJB_" + fileWP + "wp_slim/ZbbJets_" + fileWP + "wp_slim.root";
        std::string bkgPath = eosPath + "NtupleSlim/MJB_" + fileWP + "wp_slim/Multijets_" + fileWP + "wp_slim.root";
        ...
        for (int bin = 1; bin <= 8 && bin <= dataCutflow->GetNbinsX(); ++bin) {
    ...
    for (int wpIndex = 0; wpIndex < workingPoints.size(); ++wpIndex) {
        ...
        legendComp->AddEntry(bkgEfficiencyHistograms[wpIndex], "Multijets", "lp");
        ...
        canvasComp->SaveAs(("../Plots/MJB/CutFlow/EfficiencyComparison_DataSignalBkg_WP" + workingPoints[wpIndex] + ".pdf").c_str());
        //canvasComp->SaveAs(("../Plots/MJB/CutFlow/EfficiencyComparison_DataSignalBkg_WP" + workingPoints[wpIndex] + ".png").c_str());
    ...
    for (int wpIndex = 0; wpIndex < workingPoints.size() && wpIndex < 9; ++wpIndex) {
        ...
        if (wpIndex == 0) {
            ...
            legendSmall->AddEntry(signalClone, "Z(#rightarrowbb)+jets", "lp");
            legendSmall->AddEntry(bkgClone, "Multijets", "lp");
            legendSmall->Draw();
        }
    }
    
    canvasAll->SaveAs("../Plots/MJB/CutFlow/EfficiencyComparison_AllWPs_Grid.pdf");
    //canvasAll->SaveAs("../Plots/MJB/CutFlow/EfficiencyComparison_AllWPs_Grid.png");
...
void CompareEfficienciesData() {
    ...
    for (size_t i = 0; i < workingPoints.size(); ++i) {
        ...
        // Process DATA file
        std::string filePath = eosPath + "NtupleSlim/MJB_" + fileWP + "wp_slim/data_" + fileWP + "wp_slim.root";
    ...
    canvasEff->SaveAs("../Plots/MJB/CutFlow/DataEfficiencyComparison_log.pdf");
    //canvasEff->SaveAs("../Plots/MJB/CutFlow/DataEfficiencyComparison_log.png");
    ...
    canvasSignal->SaveAs("../Plots/MJB/CutFlow/SignalEfficiencyComparison_log.pdf");
    //canvasSignal->SaveAs("../Plots/MJB/CutFlow/SignalEfficiencyComparison_log.png");
    ...
    canvasBkg->SaveAs("../Plots/MJB/CutFlow/BackgroundEfficiencyComparison_log.pdf");
    //canvasBkg->SaveAs("../Plots/MJB/CutFlow/BackgroundEfficiencyComparison_log.png");
    ...
    canvasEffLinear->SaveAs("../Plots/MJB/CutFlow/DataEfficiencyComparison_Linear.pdf");
    //canvasEffLinear->SaveAs("../Plots/MJB/CutFlow/DataEfficiencyComparison_Linear.png");
...
void CompareSignalToBackground() {
    ...
    for (const auto& wp : workingPoints) {
        ...
        std::string dataPath = basePath + "NtupleSlim/MJB_" + fileWP + "wp_slim/data_" + fileWP + "wp_slim.root";
        std::string zbbPath = basePath + "NtupleSlim/MJB_" + fileWP + "wp_slim/ZbbJets_" + fileWP + "wp_slim.root";
        std::string mjPath = basePath + "NtupleSlim/MJB_" + fileWP + "wp_slim/Multijets_" + fileWP + "wp_slim.root";
        ...
        // Calculate scale factor for multijets (normalization bin is 4)
        double normBin = 4;
    ...
    // Save the plot
    canvasSB->SaveAs("../Plots/MJB/CutFlow/SignalToBackgroundRatio.pdf");
    //canvasSB->SaveAs("../Plots/MJB/CutFlow/SignalToBackgroundRatio.png");
...
void CompareDataToMC() {
    ...
    for (int i = 0; i < workingPoints.size(); ++i) {
        ...
        std::string dataPath = eosPath + "NtupleSlim/MJB_" + fileWP + "wp_slim/data_" + fileWP + "wp_slim.root";
        std::string zbbPath = eosPath + "NtupleSlim/MJB_" + fileWP + "wp_slim/ZbbJets_" + fileWP + "wp_slim.root";
        std::string mjPath = eosPath + "NtupleSlim/MJB_" + fileWP + "wp_slim/Multijets_" + fileWP + "wp_slim.root";
    ...
    // Save the plot
    canvasDMC->SaveAs("../Plots/MJB/CutFlow/DataMCRatio.pdf");
    //canvasDMC->SaveAs("../Plots/MJB/CutFlow/DataMCRatio.png");
...
void IndividualStackedCutflows() {
    ...
    for (const auto& wp : workingPoints) {
        ...
        legend->AddEntry(hZbb, "Z(#rightarrowbb)+jets", "f");
        legend->AddEntry(hMJ, "Multijets", "f");
        legend->Draw();
        ...
        canvas->SaveAs(("../Plots/MJB/CutFlow/StackedCutflow_WP" + labelWP + ".pdf").c_str());
        //canvas->SaveAs(("../Plots/MJB/CutFlow/StackedCutflow_WP" + labelWP + ".png").c_str());
        
        // FIXED: Print cutflow table with correct working point
        std::cout << "\nCutflow table for working point " << labelWP << ":" << std::endl;
        std::cout << "+------+----------------------+-----------------+--------------------+---------------------+----------------+\n";
        std::cout << "| Cut  | Description          | Data            | Z->bb+jets         | Multijets           | Data/MC        |\n";
        std::cout << "+------+----------------------+-----------------+--------------------+---------------------+----------------+\n";
        
        // Open a file to save the cutflow table
        std::ofstream cutflowFile;
        cutflowFile.open(("../Plots/MJB/CutFlow/CutflowTable_WP" + labelWP + ".txt").c_str());
        
        cutflowFile << "Cutflow table for working point " << labelWP << ":\n";
        cutflowFile << "+------+----------------------+-----------------+--------------------+---------------------+----------------+\n";
        cutflowFile << "| Cut  | Description          | Data            | Z->bb+jets         | Multijets           | Data/MC        |\n";
        cutflowFile << "+------+----------------------+-----------------+--------------------+---------------------+----------------+\n";
        ...
        summary << "  - Final multijets events: " << finalMjEvents << "\n";
        ...
        cutflowFile << "+------+----------------------+-----------------+-----------------+-----------------+\n";
        cutflowFile << "| Cut  | Description          | Data            | Z->bb+jets      | Multijets       |\n";
        cutflowFile << "+------+----------------------+-----------------+-----------------+-----------------+\n";
        ...
        // Close the file
        cutflowFile.close();
        std::cout << "Cutflow table saved to: " << ("../Plots/MJB/CutFlow/CutflowTable_WP" + labelWP + ".txt") << std::endl;
        ...
        if (dataInitial > 0 && zbbInitial > 0 && mjInitial > 0) {
            ...
            legendEff->AddEntry(hZbbEff, "Z(#rightarrowbb)+jets", "l");
            legendEff->AddEntry(hMJEff, "Multijets", "l");
            legendEff->Draw();
            ...
            // Save the plot
            canvasEff->SaveAs(("../Plots/MJB/CutFlow/Efficiency_WP" + labelWP + ".pdf").c_str());
            //canvasEff->SaveAs(("../Plots/MJB/CutFlow/Efficiency_WP" + labelWP + ".png").c_str());
...
void CutFlow() {
    ...
    std::string outputPath = "../Plots/MJB/CutFlow/";
