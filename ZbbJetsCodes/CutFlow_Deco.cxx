...
void CompareEfficiencies() {
    ...
    for (size_t i = 0; i < workingPoints.size(); ++i) {
        ...
        std::string dataPath = eosPath + "NtupleSlim/MJB_Deco_" + fileWP + "wp_slim/data_deco_" + fileWP + "wp_slim.root";
    ...
    for (int wpIndex = 0; wpIndex < workingPoints.size(); ++wpIndex) {
        ...
        canvasComp->SaveAs(("../Plots/MJB_Deco/CutFlow/EfficiencyComparison_DataSignalBkg_WP" + workingPoints[wpIndex] + ".pdf").c_str());
        //canvasComp->SaveAs(("../Plots/MJB_Deco/CutFlow/EfficiencyComparison_DataSignalBkg_WP" + workingPoints[wpIndex] + ".png").c_str());
    ...
    canvasAll->SaveAs("../Plots/MJB_Deco/CutFlow/EfficiencyComparison_AllWPs_Grid.pdf");
    //canvasAll->SaveAs("../Plots/MJB_Deco/CutFlow/EfficiencyComparison_AllWPs_Grid.png");
...
void CompareEfficienciesData() {
    ...
    canvasEff->SaveAs("../Plots/MJB_Deco/CutFlow/DataEfficiencyComparison_log.pdf");
    //canvasEff->SaveAs("../Plots/MJB_Deco/CutFlow/DataEfficiencyComparison_log.png");
    ...
    canvasSignal->SaveAs("../Plots/MJB_Deco/CutFlow/SignalEfficiencyComparison_log.pdf");
    //canvasSignal->SaveAs("../Plots/MJB_Deco/CutFlow/SignalEfficiencyComparison_log.png");
    ...
    canvasBkg->SaveAs("../Plots/MJB_Deco/CutFlow/BackgroundEfficiencyComparison_log.pdf");
    //canvasBkg->SaveAs("../Plots/MJB_Deco/CutFlow/BackgroundEfficiencyComparison_log.png");
    ...
    canvasEffLinear->SaveAs("../Plots/MJB_Deco/CutFlow/DataEfficiencyComparison_Linear.pdf");
    //canvasEffLinear->SaveAs("../Plots/MJB_Deco/CutFlow/DataEfficiencyComparison_Linear.png");
...
void CompareSignalToBackground() {
    ...
    for (const auto& wp : workingPoints) {
        ...
        std::string dataPath = basePath + "NtupleSlim/MJB_Deco_" + fileWP + "wp_slim/data_deco_" + fileWP + "wp_slim.root";
        std::string zbbPath = basePath + "NtupleSlim/MJB_Deco_" + fileWP + "wp_slim/ZbbJets_deco_" + fileWP + "wp_slim.root";
        std::string mjPath = basePath + "NtupleSlim/MJB_Deco_" + fileWP + "wp_slim/Multijets_deco_" + fileWP + "wp_slim.root";
    ...
    // Save the plot
    canvasSB->SaveAs("../Plots/MJB_Deco/CutFlow/SignalToBackgroundRatio.pdf");
    //canvasSB->SaveAs("../Plots/MJB_Deco/CutFlow/SignalToBackgroundRatio.png");
...
void CompareDataToMC() {
    ...
    for (int i = 0; i < workingPoints.size(); ++i) {
        ...
        std::string dataPath = eosPath + "NtupleSlim/MJB_Deco_" + fileWP + "wp_slim/data_deco_" + fileWP + "wp_slim.root";
        std::string zbbPath = eosPath + "NtupleSlim/MJB_Deco_" + fileWP + "wp_slim/ZbbJets_deco_" + fileWP + "wp_slim.root";
        std::string mjPath = eosPath + "NtupleSlim/MJB_Deco_" + fileWP + "wp_slim/Multijets_deco_" + fileWP + "wp_slim.root";
    ...
    // Save the plot
    canvasDMC->SaveAs("../Plots/MJB_Deco/CutFlow/DataMCRatio.pdf");
    //canvasDMC->SaveAs("../Plots/MJB_Deco/CutFlow/DataMCRatio.png");
...
void IndividualStackedCutflows() {
    ...
    for (const auto& wp : workingPoints) {
        ...
        canvas->SaveAs(("../Plots/MJB_Deco/CutFlow/StackedCutflow_WP" + labelWP + ".pdf").c_str());
        //canvas->SaveAs(("../Plots/MJB_Deco/CutFlow/StackedCutflow_WP" + labelWP + ".png").c_str());
        ...
        cutflowFile.open(("../Plots/MJB_Deco/CutFlow/CutflowTable_WP" + labelWP + ".txt").c_str());
        ...
        // Close the file
        cutflowFile.close();
        std::cout << "Cutflow table saved to: " << ("../Plots/MJB_Deco/CutFlow/CutflowTable_WP" + labelWP + ".txt") << std::endl;
        ...
        if (dataInitial > 0 && zbbInitial > 0 && mjInitial > 0) {
            ...
            // Save the plot
            canvasEff->SaveAs(("../Plots/MJB_Deco/CutFlow/Efficiency_WP" + labelWP + ".pdf").c_str());
            //canvasEff->SaveAs(("../Plots/MJB_Deco/CutFlow/Efficiency_WP" + labelWP + ".png").c_str());
...
void CutFlow_Deco() {
    ...
    std::string outputPath = "../Plots/MJB_Deco/CutFlow/";
