...
void CompareEfficiencies() {
    ...
    canvasEff->SaveAs("../Plots/MJB/Efficiency/DataEfficiencyComparison_log.pdf");
    //canvasEff->SaveAs("../Plots/MJB/Efficiency/DataEfficiencyComparison_log.png");
    ...
    legendSignal->SetTextSize(0.025);
    ...
    canvasSignal->SaveAs("../Plots/MJB/Efficiency/SignalEfficiencyComparison_log.pdf");
    //canvasSignal->SaveAs("../Plots/MJB/Efficiency/SignalEfficiencyComparison_log.png");
    ...
    canvasBkg->SaveAs("../Plots/MJB/Efficiency/BackgroundEfficiencyComparison_log.pdf");
    //canvasBkg->SaveAs("../Plots/MJB/Efficiency/BackgroundEfficiencyComparison_log.png");
    ...
    legendLinear->SetTextSize(0.025);
    ...
    canvasEffLinear->SaveAs("../Plots/MJB/Efficiency/DataEfficiencyComparison_Linear.pdf");
    //canvasEffLinear->SaveAs("../Plots/MJB/Efficiency/DataEfficiencyComparison_Linear.png");
...
void Efficiency() {
    ...
    std::string outputPath = "../Plots/MJB/Efficiency/";
