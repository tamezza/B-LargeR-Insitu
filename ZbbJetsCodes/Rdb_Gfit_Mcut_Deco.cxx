...
void CreateDirectories(const char* wp_label) {
    ...
    TString baseDirCmd = Form("mkdir -p ../Plots/MJB_Deco/FitRdbMcut/%s", wp_label);
    ...
    for (int i = 0; i < nMassCuts; i++) {
        TString dirCmd = Form("mkdir -p ../Plots/MJB_Deco/FitRdbMcut/%s/%s", wp_label, fileSystemMassCutLabels[i]);
...
void RunRdbAnalysis(const char* wp_label) {
    ...
    //-------------------------------------------
    TString mcFileName = Form("../../NtupleSlim/MJB_Deco_0p%swp_slim/ZbbJets_deco_0p%swp_slim.root", wp_label, wp_label);
    TString dataFileName = Form("../../NtupleSlim/MJB_Deco_0p%swp_slim/data_deco_0p%swp_slim.root", wp_label, wp_label);
    TString mulijetsFileName = Form("../../NtupleSlim/MJB_Deco_0p%swp_slim/Multijets_deco_0p%swp_slim.root", wp_label, wp_label);
    ...
    for (int m = 0; m < nMassCuts; m++) {
        ...
        fit_canvas->SaveAs(Form("../Plots/MJB_Deco/FitRdbMcut/%s/%s/scale_factor_fit.pdf", wp_label, fileSystemMassCutLabels[m]));
        ...
        mass_legend->AddEntry(h_mc_ljet_bJR10v00_mass1[m], "Z (#rightarrow bb) + Jets", "f");
        mass_legend->AddEntry(h_multijets_ljet_bJR10v00_mass1_scaled, "Multijets", "f");
        mass_legend->Draw();
        ...
        mass_canvas->SaveAs(Form("../Plots/MJB_Deco/FitRdbMcut/%s/%s/jet_mass_comparison.pdf", wp_label, fileSystemMassCutLabels[m]));
        ...
        Legend1->AddEntry(h_mc_R_DB[m], "Z (#rightarrow bb) + Jets", "f");
        ...
        mc_canvas->SaveAs(Form("../Plots/MJB_Deco/FitRdbMcut/%s/%s/Fit_R_DB_mc.pdf", wp_label, fileSystemMassCutLabels[m]));
        
        // Save MC fit parameters
        SaveFitParameters(Form("../Plots/MJB_Deco/FitRdbMcut/%s/%s/mc_fit_parameters.txt", wp_label, massCutLabels[m]),
        ...
        Legend_bkg->AddEntry(h_multijets_ljet_R_DB[m], "Multijets", "f");
        ...
        bkg_canvas->SaveAs(Form("../Plots/MJB_Deco/FitRdbMcut/%s/%s/Fit_R_DB_bkg.pdf", wp_label, fileSystemMassCutLabels[m]));
        
        // Save background fit parameters
        SaveFitParameters(Form("../Plots/MJB_Deco/FitRdbMcut/%s/%s/bkg_fit_parameters.txt", wp_label, massCutLabels[m]),
        ...
        data_canvas->SaveAs(Form("../Plots/MJB_Deco/FitRdbMcut/%s/%s/Fit_R_DB_data.pdf", wp_label, fileSystemMassCutLabels[m]));
        
        // Save data fit parameters
        SaveFitParameters(Form("../Plots/MJB_Deco/FitRdbMcut/%s/%s/data_fit_parameters.txt", wp_label, massCutLabels[m]),
        ...
        combined_canvas->SaveAs(Form("../Plots/MJB_Deco/FitRdbMcut/%s/%s/Fit_R_DB_combined.pdf", wp_label, fileSystemMassCutLabels[m]));
        
        // Save combined MC fit parameters
        SaveFitParameters(Form("../Plots/MJB_Deco/FitRdbMcut/%s/%s/combined_fit_parameters.txt", wp_label, massCutLabels[m]),
        ...
        combinedstack_canvas->SaveAs(Form("../Plots/MJB_Deco/FitRdbMcut/%s/%s/R_DB_stack_ratio_combined.pdf", wp_label, fileSystemMassCutLabels[m]));
    ...
    DrawAtlasLabel(wp_label); // Pass working point label
    mean_canvas->SaveAs(Form("../Plots/MJB_Deco/FitRdbMcut/%s/R_DB_mean_vs_masscut.pdf", wp_label));
    /*delete mean_canvas;
    delete g_mc_mean;
    delete g_data_mean;
    delete g_bkg_mean;
    ...
    DrawAtlasLabel(wp_label); // Pass working point label
    sigma_canvas->SaveAs(Form("../Plots/MJB_Deco/FitRdbMcut/%s/R_DB_sigma_vs_masscut.pdf", wp_label));
    /*delete sigma_canvas;
    delete g_mc_sigma;
    delete g_data_sigma;
    delete g_bkg_sigma;
    ...
    DrawAtlasLabel(wp_label); // Pass working point label
    mean_ratio_canvas->SaveAs(Form("../Plots/MJB_Deco/FitRdbMcut/%s/R_DB_mean_ratio_vs_masscut.pdf", wp_label));
    ...
    DrawAtlasLabel(wp_label); // Pass working point label
    sigma_ratio_canvas->SaveAs(Form("../Plots/MJB_Deco/FitRdbMcut/%s/R_DB_sigma_ratio_vs_masscut.pdf", wp_label));
    ...
    */
    ...
    ofstream summaryTable(Form("../Plots/MJB_Deco/FitRdbMcut/%s/R_DB_summary_table.txt", wp_label));
    if (summaryTable.is_open()) {
        ...
        summaryTable.close();
        std::cout << "Summary table saved to ../Plots/MJB_Deco/FitRdbMcut/" << wp_label << "/R_DB_summary_table.txt" << std::endl;
    } else {
