...
void CreateDirectories(const char* wp_label) {
    ...
    TString baseDir = Form("../Plots/MJB_Deco/PlotsRdbpTbin/%s", wp_label);
...
void ProcessWorkingPoint(const char* wp_label) {
    ...
    std::string dataPath = basePath + "NtupleSlim/MJB_Deco_" + wp_label + "wp_slim/data_deco_" + wp_label + "wp_slim.root";
    std::string zbbPath = basePath + "NtupleSlim/MJB_Deco_" + wp_label + "wp_slim/ZbbJets_deco_" + wp_label + "wp_slim.root";
    std::string mjPath = basePath + "NtupleSlim/MJB_Deco_" + wp_label + "wp_slim/Multijets_deco_" + wp_label + "wp_slim.root";
    ...
    tree_mc->SetBranchAddress("ljet_bJR10v00_pt", &ljet_bJR10v00_pt);
    tree_data->SetBranchAddress("ljet_bJR10v00_pt", &ljet_bJR10v00_pt);
    tree_mulijets->SetBranchAddress("ljet_bJR10v00_pt", &ljet_bJR10v00_pt);
    ...
    for (Long64_t i = 0; i < nentries; i++) {
        tree_mc->GetEntry(i);
        if (ljet_bJR10v00_pt->empty() || ljet_bJR10v00_mass->empty()) continue; // Skip if no jets
        double leadingJetPt = (*ljet_bJR10v00_pt)[0]/1000.0; // Convert MeV to GeV
    ...
    for (int m = 0; m < nMassCuts; m++) {
        ...
        TH1F *h_mc_ljet_bJR10v00_mass1 = new TH1F(Form("h_mc_ljet_bJR10v00_mass1_masscut%s_%s", massCutLabels[m], wp_label), "ljet_bJR10v00_mass", 20, 50, 150);
        TH1F *h_data_ljet_bJR10v00_mass1 = new TH1F(Form("h_data_m1_masscut%s_%s", massCutLabels[m], wp_label), "ljet_bJR10v00_mass", 20, 50, 150);
        TH1F *h_multijets_ljet_bJR10v00_mass1 = new TH1F(Form("h_multijets_ljet_bJR10v00_mass1_masscut%s_%s", massCutLabels[m], wp_label), "ljet_bJR10v00_mass", 20, 50, 150);
        ...
        for (Long64_t i = 0; i < nentries; i++) {
            ...
            double jetMass = (*ljet_bJR10v00_mass)[0]/1000.0;
            ...
            if (passesCut) {
                h_mc_ljet_bJR10v00_mass1->Fill(jetMass, weight);
            }
        }
        ...
        for (Long64_t i = 0; i < nentries; i++) {
            ...
            if (passesCut) {
                h_data_ljet_bJR10v00_mass1->Fill(jetMass);
            }
        }
        ...
        for (Long64_t i = 0; i < nentries; i++) {
            ...
            if (passesCut) {
                h_multijets_ljet_bJR10v00_mass1->Fill(jetMass, weight_mulijets);
            }
        }
        
        // Define sideband regions (same as original code)
        int binLow1 = h_multijets_ljet_bJR10v00_mass1->FindBin(50);
        int binHigh1 = h_multijets_ljet_bJR10v00_mass1->FindBin(65);
        int binLow2 = h_multijets_ljet_bJR10v00_mass1->FindBin(110);
        int binHigh2 = h_multijets_ljet_bJR10v00_mass1->FindBin(150);
        ...
        for (int bin = binLow1; bin <= binHigh1; ++bin) {
            double bin_center = h_multijets_ljet_bJR10v00_mass1->GetBinCenter(bin);
            double data_content = h_data_ljet_bJR10v00_mass1->GetBinContent(bin);
            double mc_content = h_multijets_ljet_bJR10v00_mass1->GetBinContent(bin);
            ...
            if (mc_content > 0) {
                ...
                double data_error = h_data_ljet_bJR10v00_mass1->GetBinError(bin);
                double mc_error = h_multijets_ljet_bJR10v00_mass1->GetBinError(bin);
        ...
        for (int bin = 1; bin <= h_multijets_ljet_bJR10v00_mass1->GetNbinsX(); ++bin) {
            double bin_center = h_multijets_ljet_bJR10v00_mass1->GetBinCenter(bin);
        ...
        // Clean up
        delete h_mc_ljet_bJR10v00_mass1;
        delete h_data_ljet_bJR10v00_mass1;
        delete h_multijets_ljet_bJR10v00_mass1;
    ...
    for (int m = 0; m < nMassCuts; m++) {
        ...
        TString summaryFileName = Form("../Plots/MJB_Deco/PlotsRdbpTbin/%s/%s/R_DB_pT_binned_fit_summary.txt", wp_label, fileSystemMassCutLabels[m]);
        ...
        for (int bin = 0; bin < nPtBins; bin++) {
            ...
            Legend1->AddEntry(h_mc_R_DB_ptbin[m][bin], "Z (#rightarrow bb) + Jets", "l");
            ...
            mc_canvas->SaveAs(Form("../Plots/MJB_Deco/PlotsRdbpTbin/%s/%s/Fit_R_DB_mc_ptbin%d.pdf", wp_label, fileSystemMassCutLabels[m], bin));
            
            // Save fit parameters
            SaveFitParameters(Form("../Plots/MJB_Deco/PlotsRdbpTbin/%s/%s/mc_fit_parameters_ptbin%d.txt", wp_label, fileSystemMassCutLabels[m], bin),
                            Form("MC: Z (#rightarrow bb) + Jets (%s, Mass Cut: %s)", ptBinLabels[bin], massCutLabels[m]),
                            Mean_mc, meanErr_mc, Sigma_mc, sigmaErr_mc,
                            amp_mc, ampErr_mc, chi_mc, ndf_mc);
                            
            // Add to summary file
            if (summaryFile.is_open()) {
                summaryFile << "MC: Z (#rightarrow bb) + Jets (" << ptBinLabels[bin] << ")" << std::endl;
            ...
            data_canvas->SaveAs(Form("../Plots/MJB_Deco/PlotsRdbpTbin/%s/%s/Fit_R_DB_data_ptbin%d.pdf", wp_label, fileSystemMassCutLabels[m], bin));
            
            // Save fit parameters
            SaveFitParameters(Form("../Plots/MJB_Deco/PlotsRdbpTbin/%s/%s/data_fit_parameters_ptbin%d.txt", wp_label, fileSystemMassCutLabels[m], bin),
            ...
            Legend3->AddEntry(h_multijets_R_DB_ptbin[m][bin], "Multijets", "l");
            ...
            bkg_canvas->SaveAs(Form("../Plots/MJB_Deco/PlotsRdbpTbin/%s/%s/Fit_R_DB_bkg_ptbin%d.pdf", wp_label, fileSystemMassCutLabels[m], bin));
            
            // Save fit parameters
            SaveFitParameters(Form("../Plots/MJB_Deco/PlotsRdbpTbin/%s/%s/bkg_fit_parameters_ptbin%d.txt", wp_label, fileSystemMassCutLabels[m], bin),
            ...
            combined_canvas->SaveAs(Form("../Plots/MJB_Deco/PlotsRdbpTbin/%s/%s/Fit_R_DB_combined_MC_ptbin%d.pdf", wp_label, fileSystemMassCutLabels[m], bin));
            
            // Save fit parameters
            SaveFitParameters(Form("../Plots/MJB_Deco/PlotsRdbpTbin/%s/%s/combined_MC_fit_parameters_ptbin%d.txt", wp_label, fileSystemMassCutLabels[m], bin),
            ...
            stack_legend->AddEntry(h_mc_clone, "Z (#rightarrow bb) + Jets", "f");
            stack_legend->AddEntry(h_bkg_clone, "Multijets", "f");
            ...
            stack_canvas->SaveAs(Form("../Plots/MJB_Deco/PlotsRdbpTbin/%s/%s/R_DB_stack_comparison_ptbin%d.pdf", wp_label, fileSystemMassCutLabels[m], bin));
            ...
            h_ratio->GetYaxis()->SetTitle("Data/(Sig+Bkg)");
            ...
            combinedstack_canvas->SaveAs(Form("../Plots/MJB_Deco/PlotsRdbpTbin/%s/%s/R_DB_stack_ratio_ptbin%d.pdf", wp_label, fileSystemMassCutLabels[m], bin));
        ...
        mean_legend->AddEntry(g_mc_mean, "Z (#rightarrow bb) + Jets", "pl");
        ...
        mean_canvas->SaveAs(Form("../Plots/MJB_Deco/PlotsRdbpTbin/%s/%s/R_DB_mean_vs_pT.pdf", wp_label, fileSystemMassCutLabels[m]));
        ...
        sigma_legend->AddEntry(g_mc_sigma, "Z (#rightarrow bb) + Jets", "pl");
        ...
        sigma_canvas->SaveAs(Form("../Plots/MJB_Deco/PlotsRdbpTbin/%s/%s/R_DB_sigma_vs_pT.pdf", wp_label, fileSystemMassCutLabels[m]));
        ...
        ratio_canvas->SaveAs(Form("../Plots/MJB_Deco/PlotsRdbpTbin/%s/%s/R_DB_mean_ratio_vs_pT.pdf", wp_label, fileSystemMassCutLabels[m]));
        ...
        data_combined_canvas->SaveAs(Form("../Plots/MJB_Deco/PlotsRdbpTbin/%s/%s/R_DB_data_combined_ratio_vs_pT.pdf", wp_label, fileSystemMassCutLabels[m]));
    ...
    for (int bin = 0; bin < nPtBins; bin++) {
        ...
        mass_mean_legend->AddEntry(g_mc_mean_mass, "Z (#rightarrow bb) + Jets", "pl");
        mass_mean_legend->AddEntry(g_data_mean_mass, "Data", "pl");
        mass_mean_legend->AddEntry(g_bkg_mean_mass, "Multijets", "pl");
        ...
        mass_mean_canvas->SaveAs(Form("../Plots/MJB_Deco/PlotsRdbpTbin/%s/R_DB_mean_vs_masscut_ptbin%d.pdf", wp_label, bin));
        ...
        mass_sigma_legend->AddEntry(g_mc_sigma_mass, "Z (#rightarrow bb) + Jets", "pl");
        mass_sigma_legend->AddEntry(g_data_sigma_mass, "Data", "pl");
        mass_sigma_legend->AddEntry(g_bkg_sigma_mass, "Multijets", "pl"); 
        ...
        mass_sigma_canvas->SaveAs(Form("../Plots/MJB_Deco/PlotsRdbpTbin/%s/R_DB_sigma_vs_masscut_ptbin%d.pdf", wp_label, bin));
        ...
        mass_ratio_canvas->SaveAs(Form("../Plots/MJB_Deco/PlotsRdbpTbin/%s/R_DB_ratio_vs_masscut_ptbin%d.pdf", wp_label, bin));
    ...
    all_ratio_canvas->SaveAs(Form("../Plots/MJB_Deco/PlotsRdbpTbin/%s/R_DB_all_ratio_summary.pdf", wp_label));
    ...
    bkg_ratio_canvas->SaveAs(Form("../Plots/MJB_Deco/PlotsRdbpTbin/%s/R_DB_bkg_ratio_summary.pdf", wp_label));
