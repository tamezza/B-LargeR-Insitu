...
void MassIsolationExtractSig_MJB(const std::string& wp) {
    ...
    std::string outputDirPath = "../Plots/MJB_Deco/MassIsolation/" + fileWP + "/";
    gSystem->Exec(("mkdir -p " + outputDirPath).c_str());
    
    // Construct input file paths dynamically
    std::string mcPath = "../../NtupleSlim/MJB_Deco_" + fileWP + "wp_slim/ZbbJets_deco_" + fileWP + "wp_slim.root";
    std::string dataPath = "../../NtupleSlim/MJB_Deco_" + fileWP + "wp_slim/data_deco_" + fileWP + "wp_slim.root";
    std::string multijetsPath = "../../NtupleSlim/MJB_Deco_" + fileWP + "wp_slim/Multijets_deco_" + fileWP + "wp_slim.root";
    ...
    TH1F *h_mc_ljet_bJR10v00_mass = new TH1F("h_mc_ljet_bJR10v00_mass", "Large-R Jet Mass", 40, 50, 150);
    TH1F *h_data_ljet_bJR10v00_mass = new TH1F("h_data_ljet_bJR10v00_mass", "Large-R Jet Mass", 40, 50, 150);
    TH1F *h_multijets_ljet_bJR10v00_mass = new TH1F("h_multijets_ljet_bJR10v00_mass", "Large-R Jet Mass", 40, 50, 150);
    ...
    int binHigh1 = h_multijets_ljet_bJR10v00_mass->FindBin(75);
    int binLow2 = h_multijets_ljet_bJR10v00_mass->FindBin(110);
    int binHigh2 = h_multijets_ljet_bJR10v00_mass->FindBin(150);
    ...
    legend->AddEntry(h_mc_ljet_bJR10v00_mass, "Z (#rightarrow bb) + jets", "f");
    legend->AddEntry(h_multijets_ljet_bJR10v00_mass_scaled, "Multijets", "f");
    ...
    */
    ...
    TF1 *mc_gauss_fit = new TF1("mc_gauss_fit", "gaus", 87, 100);
    ...
    TF1 *data_gauss_fit = new TF1("data_gauss_fit", "gaus", 87, 100);
