...
void RunMassIsolationPtBinsAnalysis(const std::string& wp) {
    ...
    std::string baseOutputDirPath = "../Plots/MJB_Deco/MasspTbins/" + fileWP + "/";
    ...
    for (int ptBin = 0; ptBin < nPtBins; ptBin++) {
        ...
        TH1F *h_mc_ljet_bJR10v00_mass = new TH1F(Form("h_mc_ljet_bJR10v00_mass_pt%s", ptBinLabels[ptBin].Data()), 
                                     Form("Large-R Jet Mass (p_{T}: %d-%d GeV)", (int)ptBins[ptBin], (int)ptBins[ptBin+1]), 
                                     35, 50, 150);
        TH1F *h_data_ljet_bJR10v00_mass = new TH1F(Form("h_data_ljet_bJR10v00_mass_pt%s", ptBinLabels[ptBin].Data()), 
                                       Form("Large-R Jet Mass (p_{T}: %d-%d GeV)", (int)ptBins[ptBin], (int)ptBins[ptBin+1]), 
                                       35, 50, 150);
        TH1F *h_multijets_ljet_bJR10v00_mass = new TH1F(Form("h_multijets_ljet_bJR10v00_mass_pt%s", ptBinLabels[ptBin].Data()), 
                                           Form("Large-R Jet Mass (p_{T}: %d-%d GeV)", (int)ptBins[ptBin], (int)ptBins[ptBin+1]), 
                                           35, 50, 150);
        ...
        //h_multijets_ljet_bJR10v00_mass->Sumw2();
        ...
        int binHigh1 = h_multijets_ljet_bJR10v00_mass->FindBin(75); // Changed from 65 to 75 for consistency with previous script
        ...
        //h_multijets_ljet_bJR10v00_mass_scaled->Sumw2(); // Ensure Sumw2 is enabled for scaled histogram
        ...
        //h_signal_ljet_bJR10v00_mass->Sumw2(); // Ensure Sumw2 is enabled for signal histogram
        ...
        h_mc_ljet_bJR10v00_mass->SetFillColor(kRed);
        h_mc_ljet_bJR10v00_mass->GetYaxis()->SetRangeUser(0, h_mc_ljet_bJR10v00_mass->GetMaximum()*1.75);
        h_mc_ljet_bJR10v00_mass->GetXaxis()->SetTitle("M^{J} [GeV]"); // Added X-axis title
        h_mc_ljet_bJR10v00_mass->GetYaxis()->SetTitle("Events"); // Added Y-axis title
        ...
        /*delete h_mc_ljet_bJR10v00_mass;
        delete h_data_ljet_bJR10v00_mass;
        delete h_multijets_ljet_bJR10v00_mass;
        delete ratio_graph;
        delete fit_func;
        delete h_multijets_ljet_bJR10v00_mass_scaled;
        delete polyExpFit;
        delete h_data_sidebands;
        delete h_signal_ljet_bJR10v00_mass;
...
void MassIsolationExtractSig_PtBins_Deco() {
