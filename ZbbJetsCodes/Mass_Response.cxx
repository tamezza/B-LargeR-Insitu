...
*/
    ...
    WorkingPoint(const std::string& wp) : name(wp) {
        ...
        inputFiles = {
            "../../Data/MJB/data_0p" + wp + "wp_slim.root",          
            "../../Data/MJB/Multijets_0p" + wp + "wp_slim.root",      
            "../../Data/MJB/ZbbJets_0p" + wp + "wp_slim.root"         
            
        };
        outputDir = "../Plots/MJB/" + wp + "/MassRdb/";
    }
};
*/
...
struct WorkingPoint {
    ...
    WorkingPoint(const std::string& wp) : name(wp) {
        ...
        /*inputFiles = {
            eosPath + "NtupleSlim/MJB_0p" + wp + "wp_slim/data_0p" + wp + "wp_slim.root",          
            eosPath + "NtupleSlim/MJB_0p" + wp + "wp_slim/Multijets_0p" + wp + "wp_slim.root",      
            eosPath + "NtupleSlim/MJB_0p" + wp + "wp_slim/ZbbJets_0p" + wp + "wp_slim.root"         
        };
        ...
        inputFiles = {
            eosPath + "NtupleSlim/MJB_" + fileWP + "wp_slim/data_" + fileWP + "wp_slim.root",          
            eosPath + "NtupleSlim/MJB_" + fileWP + "wp_slim/Multijets_" + fileWP + "wp_slim.root",      
            eosPath + "NtupleSlim/MJB_" + fileWP + "wp_slim/ZbbJets_" + fileWP + "wp_slim.root"         
        };
        //outputDir = "../Plots/MJB/" + fileWP + "/MassResponse/";
        outputDir = "../Plots/MJB/MassResponse/" + fileWP + "/";
    }
